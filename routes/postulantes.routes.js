...
const { verPorstulantes, buscarPorVacante, buscarPorPasante, buscarPostulacionPorId, crearPostulacion, eliminarPostulacion, actualizarEstado, buscarEstado, verCVPorPostulacion, contadorPostulacion } = require ('../controllers/postulante.controller');
...
router.get('/contador', verificarToken, verificarRol(3), contadorPostulacion);
