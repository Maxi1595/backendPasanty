...
const { verPorstulantes, buscarPorVacante, buscarPorPasante, buscarPostulacionPorId, crearPostulacion, eliminarPostulacion, actualizarEstado, buscarEstado } = require ('../controllers/postulante.controller');
